...
from basics.model import BasicsTransformerLM   # change this if your class name is different
...
def benchmark(size, warmup_steps=5, measure_steps=10, mode="both"):
